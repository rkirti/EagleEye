...
atpg: $(OBJ_FILES) parser/parser.tab.o parser/lex.yy.o
	g++ $(OBJ_FILES) parser/parser.tab.o parser/lex.yy.o -o $(BIN_DIR)/$@ 

parser/parser.tab.o: parser/parser.tab.c parser/parser.tab.h
	gcc -c -I include/ -I parser/ parser/parser.tab.c -o parser/parser.tab.o
...
parser/lex.yy.o: parser/lex.yy.c parser/defs.h
	gcc -c -I include/ -I parser/ parser/lex.yy.c -o parser/lex.yy.o
